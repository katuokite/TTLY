...
namespace AC
{
	...
	public class MenuInventoryBox : MenuElement
	{
		...
		public override void ShowGUI (Menu menu)
		{
			...
			{
				preventInteractions = CustomGUILayout.Toggle ("Prevent interactions?", preventInteractions, apiPrefix + ".preventInteractions");
			}
			...
			{
				autoOpenDocument = CustomGUILayout.ToggleLeft ("Auto-open Document when clicked?", autoOpenDocument, apiPrefix + ".autoOpenDocument");
			}
			...
			{
				updateHotspotLabelWhenHover = CustomGUILayout.ToggleLeft ("Update Hotspot label when hovering?", updateHotspotLabelWhenHover, apiPrefix + ".updateHotspotLabelWhenHover");
			}
