	...
	public class GameCamera : _Camera
	{
		...
		public override void _Update ()
		{
			...
			if (!lockFOV)
			{
				...
				{
					_camera.orthographicSize = (dampSpeed > 0f)
												? Mathf.Lerp (_camera.orthographicSize, desiredFOV, Time.deltaTime * dampSpeed)
												: desiredFOV;
				}
				else
				{
					_camera.fieldOfView = (dampSpeed > 0f)
											? Mathf.Lerp (_camera.fieldOfView, desiredFOV, Time.deltaTime * dampSpeed)
											: desiredFOV;
				}
			}
